...
public class DecisionTableResponse {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, decisionTableResponse.id)
				...
				&& Objects.equals(this.url, decisionTableResponse.url);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, category, name, key, description, version, resourceName, deploymentId,
				parentDeploymentId, tenantId, url);
	}
